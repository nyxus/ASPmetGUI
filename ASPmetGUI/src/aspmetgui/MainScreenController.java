...
public class MainScreenController implements Initializable {
    ...
    public void drawProblem() {
        ...
        a(gc.getCanvas().getWidth() + "");
        a(gc.getCanvas().getHeight() + "");
        a(blockCollection.size() + " sizes????");
        double gridSize = (canvasWidth / (marian.getLength() - 1));

        for (int i = 1; i < blockCollection.size(); i++) {
            minx = blockCollection.get(i).getMinX();
            maxx = blockCollection.get(i).getMaxX();
            miny = blockCollection.get(i).getMinY();
            maxy = blockCollection.get(i).getMaxY();
            width = blockCollection.get(i).getWidth();
            height = blockCollection.get(i).getHeight();
            id = blockCollection.get(i).getID();
...
//            gc.setStroke(Color.BLACK);
            a("Trying to draw " + id + " at: x:" + x + ", y:" + y + ", width:" + width + ", height:" + height + ", gridsize: " + gridSize + ", marian.getLength()" + marian.getLength());
            ...
            gc.fillRect(x, y, breedte, hoogte);
            gc.rect(x, y, breedte, hoogte);
        ...
        a("I HAS DRAWN IT?");
        gridPaneProblem.add(canvasProblemGraphical, 0, 2);
    }

                ...
                while(!stopCondition.isStop(generations)){
                    ...
                    Platform.runLater(new Runnable() {
                        ...
                        @Override public void run() {
                            ...
                            XYChart.Data<String, Double> maxNode = new XYChart.Data(gen, max); 
                            XYChart.Data<String, Double> avgFitnessNode = new XYChart.Data(gen, avg); 
                            XYChart.Data<String, Double> maxCostNode = new XYChart.Data(gen, maxCosts); 
                            XYChart.Data<String, Double> minCostNode = new XYChart.Data(gen, minCosts); 
                            XYChart.Data<String, Double> avgCostNode = new XYChart.Data(gen, avgCosts); 
